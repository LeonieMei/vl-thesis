...
for min_tests in {3..7}; do
    for min_pos_tests in {2..7}; do
      ...
      time Rscript run_stan_model.R --model_stan 1 --threading --max_tree_depth 12 --min_tests ${min_tests} --min_pos_tests ${min_pos_tests} --n_iter_warmup 1000 --n_iter_sampling 1000 --n_chains 4 --simulate_data --simulate_param_sizes_all_zero --filter_by_testname "T2" --trim_neg_pcrs --exclude_lrt_samples --min_max_load 5
  done
done
