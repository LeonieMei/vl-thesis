...
time Rscript bin/run_stan_model.R --model_stan 2 --threading --max_tree_depth 12 --min_tests 3 --min_pos_tests 2 --n_iter_warmup 1000 --n_iter_sampling 2000 --n_chains 4 --filter_by_testname "T2" --trim_neg_pcrs --exclude_lrt_samples --min_max_load 5
