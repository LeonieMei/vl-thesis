// Model 2 with multi-threading to further parallelize sampling
// Broad normal prior on shift parameter with limits of -8 and 30.
// The PCR with the highest viral load within an infection is defined as Day 0.
...
data {
  ...
  vector[N_DAY] X_DAY2;                              // day of measurement in time series (day 0 is day of highest PCR)
