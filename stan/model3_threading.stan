// Like Model 1 but for fit data with original preprocessing method: 
// remove intermediate negative PCRs; keep negative PCRs 7 days before and 
// after a first/last positive PCR.
// Therefore, the boundaries of shift parameter were updated: -10, 20.
...
parameters {
  ...
  vector<lower=-10,upper=20>[G] shift;

  // error variance
  real sigma_mu; // mean

  // imputed values from negative tests
